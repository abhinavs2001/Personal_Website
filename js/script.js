...
$(function () {
	...
	// Guard ScrollSpy when sidebar menu is not present
	...
	// get_repo(); // disabled for dedicated Projects page

	$(window).on('load', function () {
		$('.loader-wrapper').fadeOut(300);
	});

	// Guard sidebar toggles for pages without sidebar
	...
	$('.navbar-brand').on('click', function (e) {
		...
		if (id) {
			addNavBg('#' + id);
			if (document.querySelector('#wrapper')) $('#wrapper').toggleClass('toggled');
		}
	});
